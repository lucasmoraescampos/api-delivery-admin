...
class ProjectRouteExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    private $collection;
    
    /**
     * ProjectRouteExport constructor.
     *
    ...
    */
    ...
    {
        return ['driver', 'status', 'finished_at', 'start_time', 'end_time', 'start_address'];
    }
